    ...
    <>
      {shopping.length === 0 ? (
        ...
        <div className='flex flex-col flex-wrap justify-evenly p-4 gap-2'>
          ...
          <p className='w-full text-right mt-4'>
            Together To Pay{' '}
          ...
          <div className='text-right mt-4'>
            <Link
              ...
              target='_blank'
              className='w-min self-end text-center text-white text-lg font-bold py-2 px-4 rounded-sm bg-green-500 hover:bg-green-400 '
            >
              PayPal
            </Link>
          </div>
